                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('student.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="studentId" class="col-md-4 col-form-label text-md-right">Student Id</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="birthDate" type="text" class="form-control @error('birthDate') is-invalid @enderror" name="birthDate" value="{{ old('birthDate') }}" placeholder="d-m-Y" required autocomplete="birthDate" autofocus>
